...
export function generateNickname(length = 8): string {
    const prefixes = [
        '快乐', '阳光', '星空', '梦想', '自由', '清风', '流水', '彩虹', '火焰', '闪电',
        '星光', '海洋', '森林', '山峰', '草原', '云朵', '月光', '晨曦', '黄昏', '秋叶',
        '冬雪', '春风', '夏雨', '秋霜', '冬阳', '云海', '雾松', '朝霞', '晚霞',
        '明月', '繁星', '银河', '宇宙', '流星', '极光', '冰雪', '露珠', '微风', '细雨',
        '暖阳', '清泉', '碧波', '翠竹', '青松', '红梅', '白莲', '紫藤', '金桂', '玉兰',
        '蝴蝶', '蜻蜓', '海鸥', '雄鹰', '骏马', '猛虎', '蛟龙', '凤凰', '麒麟', '白鹤',
        '智慧', '勇气', '希望', '温暖', '宁静', '祥和', '璀璨', '绚丽', '灿烂', '辉煌',
        '逍遥', '洒脱', '淡然', '从容', '坚定', '执着', '勇敢', '坚强', '温柔', '善良'
    ]
    const suffixes = [
        '达人', '守护者', '旅行者', '探险家', '创造者', '梦想家', '守望者', '开拓者',
        '领航员', '冒险家', '探索者', '实践者', '思考者', '行动者', '创新者', '传承者',
        '建设者', '航海家', '飞行员', '科学家', '艺术家', '工程师',
        '设计师', '程序员', '诗人', '作家', '画家', '音乐家', '舞者', '演员',
        '摄影师', '建筑师', '医生', '教师', '律师', '厨师', '农夫', '猎人'
    ]
